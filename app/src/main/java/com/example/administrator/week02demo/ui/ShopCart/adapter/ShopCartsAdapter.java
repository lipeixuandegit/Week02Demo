package com.example.administrator.week02demo.ui.ShopCart.adapter;
...
import com.example.administrator.week02demo.R;
...
import com.example.administrator.week02demo.ui.widget.AddSubView;
import com.example.administrator.week02demo.utils.SharedPreferencesUtils;
...
public class ShopCartsAdapter extends BaseExpandableListAdapter {
    ...
    public ShopCartsAdapter(Context context, List<SellerBean> groupList, List<List<GetCartsBean.DataBean.ListBean>>
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupViewHolder.cbSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                productIndex = 0;
                //全局记录一下当前更新的商家
                ShopCartsAdapter.this.groupPosition = groupPosition;
                //该商家是否选中
